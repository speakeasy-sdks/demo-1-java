...
public class PostOrgsOrgIdImagesImageIdBuildsRequest {
    /**
    ...
    public PostOrgsOrgIdImagesImageIdBuildsRequest(@JsonProperty("ImageBuildRequest") demo_1.test_1.models.shared.ImageBuildRequest imageBuildRequest, @JsonProperty("imageId") String imageId, @JsonProperty("orgId") String orgId) {
        this.imageBuildRequest = imageBuildRequest;
        this.imageId = imageId;
        this.orgId = orgId;
  }
