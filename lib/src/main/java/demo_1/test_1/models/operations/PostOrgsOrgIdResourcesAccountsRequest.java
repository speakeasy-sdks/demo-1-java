...
public class PostOrgsOrgIdResourcesAccountsRequest {
    ...
    public PostOrgsOrgIdResourcesAccountsRequest(@JsonProperty("CreateResourceAccountRequestRequest") demo_1.test_1.models.shared.CreateResourceAccountRequestRequest createResourceAccountRequestRequest, @JsonProperty("orgId") String orgId) {
        this.createResourceAccountRequestRequest = createResourceAccountRequestRequest;
        this.orgId = orgId;
  }
}
