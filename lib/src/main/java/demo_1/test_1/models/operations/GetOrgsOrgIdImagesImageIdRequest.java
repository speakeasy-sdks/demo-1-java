...
public class GetOrgsOrgIdImagesImageIdRequest {
    /**
     * The Image ID.
     * 
     * 
    ...
    public GetOrgsOrgIdImagesImageIdRequest(@JsonProperty("imageId") String imageId, @JsonProperty("orgId") String orgId) {
        this.imageId = imageId;
        this.orgId = orgId;
  }
}
