...
public class GetOrgsOrgIdAppsAppIdEnvsEnvIdDeploysRequest {
    /**
     * The Application ID.
     * 
     * 
    ...
    public GetOrgsOrgIdAppsAppIdEnvsEnvIdDeploysRequest(@JsonProperty("appId") String appId, @JsonProperty("envId") String envId, @JsonProperty("orgId") String orgId) {
        this.appId = appId;
        this.envId = envId;
        this.orgId = orgId;
  }
