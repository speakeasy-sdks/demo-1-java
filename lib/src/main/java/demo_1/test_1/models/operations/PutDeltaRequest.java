...
public class PutDeltaRequest {
    ...
    public PutDeltaRequest(@JsonProperty("DeltaRequest") demo_1.test_1.models.shared.DeltaRequest deltaRequest, @JsonProperty("appId") String appId, @JsonProperty("deltaId") String deltaId, @JsonProperty("orgId") String orgId) {
        this.deltaRequest = deltaRequest;
        this.appId = appId;
        this.deltaId = deltaId;
        this.orgId = orgId;
