...
public class DeleteOrgsOrgIdAppsAppIdEnvsEnvIdRulesRuleIdRequest {
    /**
     * The Application ID.
     * 
     * 
    ...
    public DeleteOrgsOrgIdAppsAppIdEnvsEnvIdRulesRuleIdRequest(@JsonProperty("appId") String appId, @JsonProperty("envId") String envId, @JsonProperty("orgId") String orgId, @JsonProperty("ruleId") String ruleId) {
        this.appId = appId;
        this.envId = envId;
        this.orgId = orgId;
        this.ruleId = ruleId;
